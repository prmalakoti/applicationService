...
const EmpCreate = () => {
    ...
    const handlesubmit = (e) => {
        e.preventDefault();
        const empdata = { name, email, phone, password, empId, active };
        /* Node api API */
        //   fetch("http://localhost:3000/v1/createUser",{
        //     method:"POST",
        ...
        // axios call
        axios.post(`http://localhost:3000/v1/createUser`, empdata).then(res => {
            alert('Saved successfully.')
            navigate('/');
        }).catch((err) => {
            console.log(err.message);
